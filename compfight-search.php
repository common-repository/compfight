...
class cf_search {
  ...
  function search_form($show_title = true) {
    ...
    $output .= '<input type="text" name="search-value" id="search-value" value="' . esc_attr($input_text) . '" onClick="javascript:if(this.value==\'Enter Keyword(s)\') { this.value = \'\'; };" />';
