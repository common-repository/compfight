...
define('CF_CORE_VERSION', '1.5');
define('CF_OPTIONS_KEY', 'cf_options');
define('CF_WP_MIN', 3.5);
...
class compfight {
  ...
  // add media button
  static function media_button($editor) {
    return '<a href="' . plugins_url('compfight-search.php', __FILE__) . '?TB_iframe=1&inline=1" id="add_compfight" class="button thickbox" title="Compfight"><img src="' . plugins_url('images/camera.png', __FILE__) . '" alt="Compfight" width="16" height="16" /> Compfight</a>' . $editor;
  } // media_button
  ...
  static function ajax_callback_get_photo_info() {
  ...
  static function ajax_callback_set_featured_image() {
